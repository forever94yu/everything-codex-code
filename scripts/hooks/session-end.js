 ...
 *
 * Runs when Codex/Claude session ends. Extracts a meaningful summary from
  ...
  for (const line of lines) {
    try {
      ...
      if (entry.type === 'user' || entry.role === 'user' || entry.message?.role === 'user') {
        // Support both direct content and nested message.content (Codex/Claude JSONL format)
      ...
      // Extract tool uses from assistant message content blocks (Codex/Claude JSONL format)
...
// Read hook input from stdin (Codex/Claude provides transcript_path via stdin JSON)
