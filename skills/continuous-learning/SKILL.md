...
description: Automatically extract reusable patterns from Codex Code sessions and save them as learned skills for future use.
origin: ECC
---

# Continuous Learning Skill

Automatically evaluates Codex Code sessions on end to extract reusable patterns that can be saved as learned skills.

## When to Activate

- Setting up automatic pattern extraction from Codex Code sessions
